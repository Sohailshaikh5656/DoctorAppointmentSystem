                ...
                <div class="col-lg-4">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">klinic134@gmail.com</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-light rounded p-5">
                        ...
                        <form method="post" action="inquiry.php">
                            <div class="row g-3">
                                ...
                                <?php if ($_SESSION['showAlert1']==1)
                                { echo '
                                 <div class="alert alert-success alert-dismissible fade show middle" role="alert">
  <strong>Your Inquiry has been send !</strong>&nbsp;
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div> '; $_SESSION['showAlert1']=0;}
?>
                                <div class="col-12">
