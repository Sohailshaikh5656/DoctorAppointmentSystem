...
<?php
    ...
    $sql = "Select * from clinic where clinic_type='$name'";
    $sql = "SELECT clinic.clinic_type,clinic.id,clinic.clinic_name,clinic_profile.poster_image FROM clinic,clinic_profile where clinic.approval = 1 and clinic.id=clinic_profile.clinic_id and clinic.clinic_type='$name'";
    ...
    <!-- 404 End -->
        ...
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Result</p>
                <h1><?php echo$name ?></h1>
            </div>
            <div class="row g-4">
